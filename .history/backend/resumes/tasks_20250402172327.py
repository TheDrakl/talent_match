...
# Predefined list of skills for keyword matching
SKILLS_KEYWORDS = [
    "Python", "Java", "C++", "JavaScript", "SQL", "HTML", "CSS", "Django", "Flask",
    "React", "Angular", "AWS", "Docker", "Kubernetes", "Git", "Machine Learning",
    "Deep Learning", "Data Analysis", "Project Management", "Agile", "Scrum", "Time Managment", "Problem-Solving", "MultiTaskin"
]
...
def process_resume(resume_id):
    ...
    try:
        ...
        experience = []
        for ent in doc.ents:
            if ent.label_ in ["ORG"]:  # Extract organizations
                experience.append(ent.text)
            elif ent.label_ == "DATE":  # Extract dates
                experience.append(ent.text)

        # Use regex to find job titles (e.g., "Software Engineer", "Project Manager")
